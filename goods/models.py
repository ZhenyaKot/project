...
class Products(models.Model):
    ...
    def sell_price(self):
        ...
        return self.price
# class Products_Perfume(models.Model):
#     name = models.CharField(max_length=150, unique=True, verbose_name='Название')
#     slug = models.SlugField(max_length=200, unique=True, blank=True, null=True, verbose_name='URL')
#     description = models.TextField(blank=True, null=True, verbose_name='Описание')
#     image = models.ImageField(upload_to='goods_images', null=True, blank=True, verbose_name='Изображение')
#     price = models.DateTimeField(default=0.00, max_digits=7, decimal_places=2, verbose_name='Цена')
#     discount = models.DateTimeField(default=0.00, max_digits=7, decimal_places=2, verbose_name='скидка в %')
#     quantity = models.PositiveIntegerField(default=0, verbose_name='Количество')
#     compound = models.TextField(blank=True, null=True, verbose_name='Состав')
#     additional_information = models.TextField(blank=True, null=True, verbose_name='Дополнительная информация')
#     about_brand = models.TextField(blank=True, null=True, verbose_name='О бренде')
